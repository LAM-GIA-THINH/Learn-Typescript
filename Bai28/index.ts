...
/**
 * Thử thách: thêm kiểu dữ liệu cho hàm generic `addToArray` của chúng ta. 
 * Hàm này cần hoạt động với việc thêm pizza mới vào `menu` và thêm đơn hàng mới vào `orderQueue`.
 */
